...
- project全体(experimental21以外、22以降)の課題は？
  ...
  - 22以降も含め、project全体で実証実験したいのは、なに？
    - そのために必要な実装は、なに？
  - やりたいことの一つは、このライブラリを使うことで、いろんアプリがゆるく連携すること。MIDIで連携すること。postmate-MIDIで連携すること。そういう環境づくり。そういう環境がつくれるか？エコシステムが作れるか？の実証実験。ツイートをリンクして整理するといいかも。ツイートしたことがある。ゆるく連携するプロトコルを用意するということ。そうすればものすごく先進的なものができたとき、それとゆるく連携が楽にできる。それができるようにするのが目標の一つ。
